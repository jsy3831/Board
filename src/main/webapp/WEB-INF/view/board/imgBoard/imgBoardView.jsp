...
<div class="container-fluid" id="imgBoardView">
		...
		<div class="col-lg-7">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<!-- <img v-for="list in fileList" :src="list.bfPath + list.viewThumb" title="클릭하시면 원본크기로 보실 수 있습니다." @click="imgPop(list.bfPath + list.bfStoTitle)" class="imgThumb pointer"> -->
...
<jsp:include page="/WEB-INF/view/board/imgBoard/script/imgBoardViewScript.jsp"></jsp:include>