...
<script>
	...
	var vm = new Vue({
		...
		methods: {
			...
			goBoardUpdate: function(){
				var vm = this;
				window.location.href = "/goBoardUpdate?bdCode="+vm.bdCode+"&&bcCode="+vm.bcCode+"&&bcTitle="+vm.bcTitle+"&&bcRating="+vm.bcRating+"&&bcType="+vm.bcType+"&&pbcCode="+vm.pbcCode
										+"&&currentPage="+${currentPage}+"&&selected="+${selected}+"&&searchWrd="+'${searchWrd}';
			},
