...
<!-- Begin Page Content -->
<div class="container-fluid" id="boardView">
	<div class="row">
		<div class="col-lg-7">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<div class="form-group">
						<div style="min-height:500px" class="card-body" v-html="board.bdContent"></div>
		            	
		            	<div class="table-responsive">
			                <table class="table table-bordered table-hover" width="100%" cellspacing="0">
			                	<thead>
						            <tr>
						            	<th v-if="fileList.length > 0">
						            		첨부파일 <font color="#4e73df">{{fileList.length}}개</font>
						            	</th>
						            	<th v-if="fileList.length == 0">첨부파일이 존재하지 않습니다.</th>
						          	</tr>
								</thead>
			                    <tbody>
				                    <tr v-for="list in fileList">
				                    	<td class="pointer" v-on:click="downloadFile(list)">
		            ...
		            <div class="float-left">
			            <button type="button" class="btn btn-outline-dark" v-on:click="goBoard(0)">목록보기</button>
		            </div>
		            <div class="float-right">
			            <button type="button" class="btn btn-primary" v-on:click="goBoardUpdate" v-if="memInfo.miCode == board.miCode">수정</button>
...
<!-- /.container-fluid -->    
<jsp:include page="/WEB-INF/view/board/textBoard/script/boardViewScript.jsp"></jsp:include>