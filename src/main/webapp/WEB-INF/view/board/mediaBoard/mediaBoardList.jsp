<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<!-- Begin Page Content -->
	<div class="container-fluid" id="mediaBoardList">
    				...
    				<div class="col-lg-3" v-for="(list, index) in imgBoardList">
    					<div class="card shadow mb-4">
    						<div class="card-body">
	    						...
	    						<img src="img/icons8-video-48.png"></img>
	...
	<jsp:include page="/WEB-INF/view/board/mediaBoard/script/mediaBoardListScript.jsp"></jsp:include>